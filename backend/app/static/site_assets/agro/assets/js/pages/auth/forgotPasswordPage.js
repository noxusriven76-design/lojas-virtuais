...
export function initForgotPasswordPage(){
  // Se já estiver logado, não faz muito sentido recuperar senha aqui.
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      showAlert(alertEl, { kind: 'success', message: 'Se o e-mail estiver cadastrado, você receberá instruções em instantes.' });
