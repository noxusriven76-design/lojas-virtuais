...
from app.api.routes import master
...
api_v1_router.include_router(master.router, tags=["master"])
...
legacy_router.include_router(master.router, tags=["master"], include_in_schema=False)
